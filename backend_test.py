...
class LambaliaEnhancedAPITester:
    def __init__(self, base_url="https://foodloc-platform.preview.emergentagent.com"):
        ...
        # LOD Marketplace test data
        self.lod_offer_id = None
        self.lod_demand_id = None
        self.lod_subscription_id = None
...
def main():
    ...
    print(f"Testing against: https://foodloc-platform.preview.emergentagent.com")
    print()
