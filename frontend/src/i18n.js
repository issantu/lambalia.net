  ...
  it: {
    translation: {
      ...
      auth: {
        ...
        phoneRequired: "Necessario per la sicurezza dell'account e le notifiche degli ordini",
        twoFactorTitle: "Abilita Sicurezza a Due Livelli (Consigliato)",
        ...
        twoFactorFeatures: "Codici di verifica SMS • Protezione dell'account migliorata • Pagamenti sicuri",
        subtitle: "Assapora il Patrimonio del Mondo",
        culturalInfo: "🌍 80+ Comunità Culturali • 🥄 Ricette Patrimoniali • 🛒 Ingredienti Speciali",
        nativeDishesLabel: "Quali piatti nativi della tua cultura puoi cucinare? (Questo aiuta gli utenti a trovarti e pagarti per ricette autentiche)",
        consultationLabel: "Per cosa vorresti che altri utenti ti contattassero? (Consulenze a pagamento - tu fissi le tue tariffe!)",
        culturalBgLabel: "Il Tuo Background Culturale (ci aiuta a connetterti con la comunità giusta)"
      },
      ...
      // Local Offers & Demands (LOD)
      lod: {
        title: "Offerte e Richieste Locali",
        subtitle: "Mercato Alimentare Geo-Localizzato (Lamba ORL)",
        description: "Connetti offerte e richieste alimentari locali nella tua area • 15% commissione",
        showingResults: "Mostrando risultati per:",
        availableOffers: "Offerte Disponibili",
        foodDemands: "Richieste Alimentari",
        availableFood: "Offerte Alimentari Disponibili Vicino a Te",
        demandsInArea: "Richieste Alimentari nella Tua Area",
        noOffers: "Nessuna offerta disponibile nella tua area. Sii il primo a pubblicarne una!",
        noDemands: "Nessuna richiesta nella tua area. Ricontrolla più tardi!",
        filterLocation: "Filtra per Posizione:",
        zipPlaceholder: "Inserisci codice postale",
        loadingMarket: "Caricamento dati del mercato...",
        postOfferModal: "Pubblica Offerta Alimentare",
        postDemandModal: "Pubblica Richiesta Alimentare",
        ...
        timeLeft: "rimanente",
        expired: "Scaduto",
        subscribeBuy: "Iscriviti e Acquista",
        canMake: "Posso Farlo",
        title_: "Titolo",
        dishName: "Nome del Piatto",
        description_: "Descrizione",
        cuisineType: "Tipo di Cucina",
        quantity: "Quantità (Persone)",
        pricePerPerson: "Prezzo per Persona ($)",
        postalCode_: "Il Tuo Codice Postale",
        prepTime: "Tempo di Preparazione (ore)",
        fulfillmentOptions: "Opzioni di Adempimento",
        pickupAvailable: "Ritiro Disponibile",
        deliveryAvailable: "Consegna Disponibile",
        spiceLevel: "Livello di Piccantezza",
        mild: "Dolce",
        medium: "Medio",
        hot: "Piccante",
        veryHot: "Molto Piccante",
        commissionInfo: "Info Commissione",
        commissionDesc: "Lambalia applica una commissione del 15% su tutte le transazioni.",
        earningsCalc: "Riceverai",
        fromTransaction: "da una",
        transaction: "transazione",
        titlePlaceholderOffer: "es., Riso Jollof Fresco Disponibile",
        titlePlaceholderDemand: "es., Cercando Poulet Mayo Autentico",
        dishPlaceholder: "es., Riso Jollof con Pollo",
        descPlaceholder: "Descrivi il piatto, ingredienti, stile di preparazione...",
        cuisinePlaceholder: "es., Nigeriano, Tailandese, Francese",
        postalPlaceholder: "es., 90210 o SW1A 1AA",
        subscribeSuccess: "Iscrizione riuscita a",
        contactDetails: "Verrai contattato con i dettagli del ritiro/consegna.",
        subscribeError: "Iscrizione fallita. Riprova.",
        createSuccess: "creato con successo!",
        createError: "Creazione dell'elemento fallita. Riprova.",
        miles: "miglia di distanza",
        hours: "h",
        minutes: "min"
      },
