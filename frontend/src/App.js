...
const AuthProvider = ({ children }) => {
  ...
  const resendVerificationCode = async (email, codeType = "registration") => {
    try {
      const response = await axios.post(`${API}/auth/resend-verification?email=${encodeURIComponent(email)}&code_type=${codeType}`);
      return { 
        success: true, 
        message: response.data.message 
      };
        ...
        {isLogin ? (
          show2FA ? (
            <form onSubmit={handle2FA} className="space-y-4">
              ...
              {/* Email Deliverability Notice for 2FA */}
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      ...
                      <li>Click "Resend Security Code" below if needed</li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      {showForgotPassword && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-4">Enter your email address and we'll send you a code to reset your password.</p>
      ...
      {showResetPassword && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-4">Enter the 6-digit code sent to <strong>{resetEmail}</strong></p>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              ...
              <Link to="/grocery" className="nav-link text-gray-700 hover:text-green-600 px-2 py-1.5 rounded-md text-sm font-medium flex items-center space-x-1.5">
                ...
                <span className="xl:hidden">{t('nav.ingredients')}</span>
              </Link>
              ...
              <Link to="/local-marketplace" className="nav-link text-gray-700 hover:text-green-600 px-2 py-1.5 rounded-md text-sm font-medium flex items-center space-x-1.5">
                ...
                <span className="xl:hidden">{t('nav.marketplace')}</span>
              </Link>
              ...
              <Link to="/local-offers" className="nav-link text-gray-700 hover:text-purple-600 px-2 py-1.5 rounded-md text-sm font-medium flex items-center space-x-1.5">
                ...
                <span className="xl:hidden">{t('nav.offers')}</span>
              </Link>
              ...
              <Link to="/charity-program" className="nav-link text-gray-700 hover:text-green-600 px-2 py-1.5 rounded-md text-sm font-medium flex items-center space-x-1.5">
                ...
                <span className="xl:hidden">{t('nav.charity')}</span>
              </Link>
  ...
  const RestaurantBrowsingTab = () => (
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mb-6">{t('restaurant.marketplace.subtitle')}</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <div className="glass p-4 text-center">
            <h3 className="font-semibold mb-2">🏠 {t('restaurant.marketplace.homeRestaurants')}</h3>
            <p className="text-sm text-gray-600">{t('restaurant.marketplace.intimateDining')}</p>
          ...
          <div className="glass p-4 text-center">
            ...
            <p className="text-sm text-gray-600">{t('restaurant.marketplace.specialOrders')}</p>
            <p className="font-bold text-blue-600">{specialOrders.length} {t('restaurant.marketplace.specialOrdersCount')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-bold text-gray-800 mb-4">🏠 {t('restaurant.marketplace.homeRestaurants')}</h3>
        {loading ? (
  ...
  return (
    <footer className="bg-gray-900 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Bottom Bar - Parent Company */}
        <div className="border-t border-gray-800 pt-6 mt-8">
          <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <span className="text-gray-400 text-sm">Powered by</span>
              <img 
                src="https://customer-assets.emergentagent.com/job_cuisine-finder-3/artifacts/guqfm2sn_Logo1.JPG" 
